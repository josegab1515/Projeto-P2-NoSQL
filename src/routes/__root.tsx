...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Padaria Dom Quixote · Pão de fermentação natural" },
      { property: "og:description", content: "E-commerce da Padaria Artesanal Dom Quixote: pães de fermentação natural, doces de receita antiga e bebidas artesanais." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Padaria Dom Quixote · Pão de fermentação natural" },
      { name: "twitter:description", content: "E-commerce da Padaria Artesanal Dom Quixote: pães de fermentação natural, doces de receita antiga e bebidas artesanais." },
